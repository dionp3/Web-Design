...
<template>
    <div class="bg-gray-100 ">
      <section class="relative py-12 px-4 bg-white opacity-80" style="background-image: url('bg1.png')">
        ...
        <div class="flex justify-center relative flex-col gap-20 md:flex-row items-center md:space-x-8 mb-12">
          <img src="@/assets/img/Logo.png" alt="Kreasi Kita" class="h-40 mt-40 mb-4 md:mb-0" />
        ...
        <div class="flex justify-center relative flex-col gap-20 md:flex-row items-center md:space-x-8 mb-12">
          <button class="relative mt-8 bg-[#FDB750] hover:bg-yellow-600 text-black font-semibold py-2 px-4 rounded-full">
            Explore Creations ➜
          </button>
        </div>
      </section>
    ...
    <div class="bg-gray-100">
      <!-- Join Section -->
      <section class="py-12 text-center bg-white opacity-50" style="background-image: url('bg1.png')">
          <h2 class="text-2xl text-[#FD7F20] font-bold mt-20 mb-20">Join Kreasi Kita and be part of the creator and fan community!</h2>
          <button class="mt-6 bg-[#FDB750] hover:bg-yellow-600 text-black font-semibold py-2 px-4 rounded-full">
            Register here ➜
          </button>
      </section>
    </div>
